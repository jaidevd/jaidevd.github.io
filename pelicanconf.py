...
AUTHOR = u'Jaidev Deshpande'

SITENAME = u'Broca\'s Brain'
SITESUBTITLE = u'Thoughts on data science, machine learning and signal processing.'
...
MENUITEMS = [('Archives', '/archives.html'),
        ('Home Page', 'http://github.com/jaidevd')]
