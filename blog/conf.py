...
BLOG_AUTHOR = "Jaidev Deshpande"  # (translatable)
...
BLOG_EMAIL = "deshpande.jaidev@gmail.com"
BLOG_DESCRIPTION = "Thoughts on data science, machine learning and signal processing."  # (translatable)
